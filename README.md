...
+ Step 2: Clone and open the project.
  ...
  + Open Android Studio, select `Check out project from Version Control -> Git`.
    ...
    ![android_studio_start](.\readme_resources\setup_screenshots\android_studio_start.png)

  + Type https://github.com/imJeffZ/GameCenter2018Public in the `URL` box. Then click `Clone`.

    ![git_clone](.\readme_resources\setup_screenshots\git_clone.png)

  + A prompt to create new project would be shown, select `yes`.

    ![create_new_project](.\readme_resources\setup_screenshots\create_new_project.png)

  + Select `Import project from external model`, then select `Gradle`.

    Click `Next`.

    ![import_gradle](.\readme_resources\setup_screenshots\import_gradle.png)

  + On the next page, select `···` next to the `Gradle Project` box.

    ![gradle_setup_1](.\readme_resources\setup_screenshots\gradle_setup_1.png)

  + Select `GameCenter2018Public -> Phase2 -> GameCenter/` to open the cloned application.

    Then click `OK`.

    ![gradle_location](.\readme_resources\setup_screenshots\gradle_location.png)
...
+ Step 3: Configure Android Studio.
  ...
  **Configure Android SDK.**
  ...
  + After we've open the project, the window of Android Studio would open up.
    ...
    ![android_studio_prompt_gradle](.\readme_resources\setup_screenshots\android_studio_prompt_gradle.png)

  + Download the required Android 8.1 (Oreo) API level 27.

    On the top navigation panel, select `Tools -> SDK Manager`.

    ![android_studio_tools](.\readme_resources\setup_screenshots\android_studio_tools.png)

  + Select `Android 8.1 (Oreo)` . Click `OK`.

    ![android_sdk](.\readme_resources\setup_screenshots\android_sdk.png)
  ...
  **Configure Android Virtual Device.**
  ...
  + Select `Pixel 2`. Click `Next`.
    ...
    ![select_pixel2](.\readme_resources\setup_screenshots\select_pixel2.png)
...
+ Step 4: Run the Game.
  ...
  + On the main window of Android Studio, click on the green triangular button.
    ...
    ![run_button](.\readme_resources\run_button.png)

  + Select `Pixel 2 API 27`. Click `OK`.

    ![select_run_device](.\readme_resources\select_run_device.png)
  ...
  + When finished, the login screen of the application would open up in the virtual device.
    ...
    ![login_screen](.\readme_resources\login_screen.png)
...
![registration](.\readme_resources\application_screenshots\registration.png)

##### Login

After registration, you will be redirected back to login screen, login with your account credentials to proceed.
![login](.\readme_resources\application_screenshots\login.png)
...
![gamecenter](.\readme_resources\application_screenshots\gamecenter.png)

###### Profile 

![profile](.\readme_resources\application_screenshots\profile.png)

##### Start Game

We would take *SlidingTiles* in the *Game Center* as an example.

![slidingtiles_start](.\readme_resources\application_screenshots\slidingtiles_start.png)
...
+ To play the game:
  ...
  ![st_complexity](.\readme_resources\application_screenshots\st_complexity.png)
...
![st_game](.\readme_resources\application_screenshots\st_game.png)
...
![gamefinish](.\readme_resources\application_screenshots\gamefinish.png)
...
![gamescore](.\readme_resources\application_screenshots\gamescore.png)
...
![userhistory_button](.\readme_resources\application_screenshots\userhistory_button.png)

Select the type of game that you want to see completed games from.

![userhistory_drawer](.\readme_resources\application_screenshots\userhistory_drawer.png)



![userhistory_dropdown](.\readme_resources\application_screenshots\userhistory_dropdown.png)



![userhistory_record](.\readme_resources\application_screenshots\userhistory_record.png)
...
![replay](.\readme_resources\application_screenshots\replay.png)

##### Global Scoreboard

There is also a `Global ScoreBoard` that records the scores and player email of every completed game.

![globalscoreboard_button](.\readme_resources\application_screenshots\globalscoreboard_button.png)

![globalscoreboard_record](.\readme_resources\application_screenshots\globalscoreboard_record.png)

##### Saved Games

Users can view all saved games by clicking the `LOAD GAME` button in a game's welcome page.

![load_games](.\readme_resources\application_screenshots\load_games.png)
...
![savedgames](.\readme_resources\application_screenshots\savedgames.png)
